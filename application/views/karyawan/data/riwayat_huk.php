...
<html lang="en">
    ...
    <main class="app-content">
        <div class="app-title">
        <div>
            <h1><i class="fa fa-pie-chart"></i> Riwayat Hukuman </h1>
            <p></p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item active"><a href="<?php echo base_url() ?>index.php/karyawan/data/riwayat pendidikan/pend_formal"> Riwayat Hukuman</a></li>
        </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
