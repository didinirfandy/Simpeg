                    ...
                    <div class="tile">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane" id="c_pjg" role="tabpanel" aria-labelledby="c_pjg-tab">
                                ...
                                $total = $this->db->query("SELECT SUM(IF(YEAR(tgl), jmlh_hari, 0)) AS total FROM tb_cuti_pjg WHERE npp = '$npp'")->result_array();
                                $tgl   = $total[0]['total'];
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <?php 
                                                $npp  = $this->session->userdata('status_login_username');
                                                $cuti = $this->db->query("SELECT * FROM cuti_pjg WHERE npp = '$npp' GROUP BY npp")->row_array();
                                                if($cuti == "")
                                                { echo "";
                                                } else { ?>
                                                <small class="form-text text-muted">Jangan Melebihi <?php $sisa_cuti = $this->Model_admin->quota_cuti_pjg();
                                                                                                        $sisa      = $sisa_cuti[0]['sisa_tb_cuti_pjg'];
                                                                                                        echo $sisa;
                                                                                                        ?> Hari</small>
                                                <?php } ?>
                                                <input class="form-control" type="hidden" name="npp" value="<?= $this->session->userdata('status_login_username'); ?>">
                            ...
                            <div class="tab-pane active" id="c_thn" role="tabpanel" aria-labelledby="c_thn-tab">
                                ...
                                <?php
                                $npp   = $this->session->userdata('status_login_username');
                                $total = $this->db->query("SELECT SUM(IF(YEAR(tgl), jmlh_hari, 0)) AS total FROM tb_cuti_thn WHERE npp = '$npp'")->result_array();
                                $tgl   = $total[0]['total'];
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <small class="form-text text-muted">Jangan Melebihi <?php $sisa_cuti = $this->Model_admin->quota_cuti_thn();
