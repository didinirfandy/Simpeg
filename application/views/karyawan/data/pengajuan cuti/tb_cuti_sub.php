...
if (empty($_SESSION['status_login'])) {
    ...
    <head>
        ...
        <?php
        $data['tittle'] = " Status Pengajuan Cuti ";
    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-user-times"></i> Status Pengajuan Cuti </h1>
                    <p></p>
                </div>
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                    <li class="breadcrumb-item"> Pengajuan Cuti</li>
                    <li class="breadcrumb-item active"><a href="<?php echo base_url() ?>index.php/karyawan/data/cuti"> Status Pengajuan Cuti </a></li>
                </ul>
            </div>
            <!-- Swetalert Berhasil -->
                                                ...
                                                foreach ($quota_sakit as $v) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php
                                                            $npp = $v['npp'];
                                                            $jumlah = $this->db->query("SELECT SUM(jmlh_hari) AS jumlah FROM `cuti_sakit` WHERE npp=$npp GROUP BY npp=$npp")->result_array();
                                                            foreach ($jumlah as $key) {
                                                                echo $key['jumlah'];
                                                            }
                                                            ?>
