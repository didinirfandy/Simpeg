...
<body>
	...
	<section class="login-content">
		...
		<div class="login-box">
			<form class="login-form" method="POST" action="<?= base_url('index.php/Core/lg_su'); ?>">
				<h3 class="login-head"><i class="fa fa-lg fa-fw fa-user"></i>SIGN IN SU ADMIN</h3>
			...
			<form class="forget-form" method="POST" action="<?= base_url('index.php/Core/lg_su'); ?>">
