    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                echo form_open('admin/input_sdm/sdm14',$attributes);?>

                    <h3 class="tile-title">Form Input SDM 14</h3>
                    ...
                    <div class="tile-body">
                        ...
                        <a class="btn btn-secondary" href="<?php echo base_url() ?>index.php/admin/kembali/out_sdm14"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                        </div>
                    </div>
                    <?php echo form_close() ?>
                </div>
