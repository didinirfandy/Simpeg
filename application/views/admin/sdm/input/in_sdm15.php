    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                echo form_open('admin/input_sdm/sdm15',$attributes);?>
                    ...
                    <div class="tile-body">
                        ...
                        <a class="btn btn-secondary" href="<?php echo base_url() ?>index.php/admin/kembali/out_sdm15"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                        </div>
                    </div>
                    <?php echo form_close() ?>
                </div>
