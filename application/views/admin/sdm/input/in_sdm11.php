    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php $attributes = array('id_sdm11' => 'regForm'); 
                echo form_open('admin/input_sdm/sdm11',$attributes);?>

                    <h3 class="tile-title">Form Input SDM 11</h3>
                    ...
                    <div class="tile-body">
                        ...
                        <a class="btn btn-secondary" href="<?php echo base_url() ?>index.php/admin/kembali/out_sdm11"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                        </div>
                    </div>
                    <?php echo form_close() ?>
                </div>
