...
if (empty($_SESSION['status_login'])) {
    ...
    <body class="app sidebar-mini rtl">
        <!-- Navbar-->
        <header class="app-header"><a class="app-header__logo" href="<?= base_url() ?>index.php/welcome/in_admin">SIMPEG</a>
        ...
        <main class="app-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <?= form_open('admin/tabel_sdm/in_sdm08'); ?>
                        ...
                        <div class="tile-body">
                            ...
                            <div class="tile-footer row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <a class="btn btn-secondary" href="<?= base_url() ?>index.php/admin/tabel_sdm/in_sdm08"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Kembali</a>
                                </div>
                            </div>
                        </div>
                        <?= form_close() ?>
