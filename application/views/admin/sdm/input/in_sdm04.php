...
if (empty($_SESSION['status_login'])) {
    ...
    <head>
        ...
        <?php
        $data['tittle'] = "From Input Pelatihan";
        ...
        <main class="app-content">
            <div class="app-title">
                ...
                <ul class="app-breadcrumb breadcrumb side">
                    ...
                    <li class="breadcrumb-item active"><a href="<?php echo base_url() ?>index.php/admin/tabel_sdm/sdm04"> Pelatihan</a></li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <?= form_open('admin/tabel_sdm/in_sdm04'); ?>
                        <h3 class="tile-title">Form Input Pelatihan</h3>
                        ...
                        <div class="tile-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-1"></div>
                                    <label class="control-label col-md-2 text-right">No Sertifikat</label>
                                    <div class="col-md-6">
                            ...
                            <div class="tile-footer row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <a class="btn btn-secondary" href="<?php echo base_url() ?>index.php/admin/tabel_sdm/in_sdm04"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Kembali</a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close() ?>
