    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php $attributes = array('id_sdm12' => 'regForm'); 
                echo form_open('admin/input_sdm/sdm12',$attributes);?>

                    <h3 class="tile-title">Form Input SDM 12</h3>
                    ...
                    <div class="tile-body">
                        ...
                        <a class="btn btn-secondary" href="<?php echo base_url() ?>index.php/admin/kembali/out_sdm12"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                        </div>
                    </div>
                    <?php echo form_close() ?>
                </div>
