...
if (empty($_SESSION['status_login'])) {
    ...
    <head>
        ...
        <?php
        $data['tittle'] = "From Input History Kenaikan Golonagan";
    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-th-list"></i> History Kenaikan Golonagan</h1>
                    <p></p>
                </div>
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                    <li class="breadcrumb-item">Tabel Kepegawaian</li>
                    <li class="breadcrumb-item active"><a href="<?php echo base_url() ?>index.php/admin/tabel_sdm/sdm16"> History Kenaikan Golonagan</a></li>
                </ul>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <?= form_open('admin/tabel_sdm/in_sdm16'); ?>
                        <h3 class="tile-title">Form Input History Kenaikan Golonagan</h3>
                        ...
                        <div class="tile-body">
                            <form class="form-horizontal">
                                        ...
                                        <select class="form-control" name="golongan">
                                            <optgroup label="Pilih Status Sipil">
                                                ...
                                                <?php foreach ($gol as $g) { ?>
                                                    <option value="<?= $g['kd_gol'] ?>"><?= $g['gol'] ?></option>
                                                <?php } ?>
                                            </optgroup>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select class="form-control" name="jns_naik">
                                            <optgroup label="Pilih Status Sipil">
                                                <option value="">---PILIH---</option>
                                                <?php foreach ($naik as $n) { ?>
                                                    <option value="<?= $n['jns_naik'] ?>"><?= $n['nama'] ?></option>
                                                <?php } ?>
                                            </optgroup>
                                        </select>
                                    </div>
                            ...
                            <div class="tile-footer row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <a class="btn btn-secondary" href="<?php echo base_url() ?>index.php/admin/tabel_sdm/in_sdm16"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Kembali</a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close() ?>
