...
if (empty($_SESSION['status_login'])) {
    ...
    <?php
        $data['tittle'] = "From Input Jubilium";
    ...
    <body class="app sidebar-mini rtl">
        ...
        <main class="app-content">
            <div class="app-title">
                <div>
                    <h1><i class="fa fa-th-list"></i> Jubilium</h1>
                    <p></p>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <?= form_open('admin/tabel_sdm/in_sdm13'); ?>
                        <h3 class="tile-title">Form Input Jubilium</h3>
                        ...
                        <div class="tile-body">
                            <form class="form-horizontal">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-1"></div>
                                    <label class="control-label col-md-2 text-right">Jns Harga</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-1"></div>
                                    <label class="control-label col-md-2 text-right">Tanggal Harga</label>
                                    <div class="col-md-6">
                            ...
                            <div class="tile-footer row">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <a class="btn btn-secondary" href="<?php echo base_url() ?>index.php/admin/tabel_sdm/in_sdm13"><i class="fa fa-fw fa-lg fa-arrow-left"></i>Kembali</a>
                                </div>
                            </div>
                        </div>
                        <?php echo form_close() ?>
