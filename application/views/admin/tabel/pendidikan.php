            ...
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-title-w-btn">
                        <h3 class="title"></h3>
                        <p><a class="btn btn-primary icon-btn" href="<?php echo base_url() ?>index.php/admin/input_tabel/pendidikan"><i class="fa fa-plus"></i>Add Item	</a></p>
                    </div>
                    <div class="tile-body">
                        <table class="table table-hover table-bordered" id="sampleTable">
                            ...
                            <tbody>
                                <?php foreach ($tpend->result_array() as $i) { ?>
                                    <tr>
                                        <td><?php echo $i['kd_pend'] ?></td>
                                        <td><?php echo $i['nm_pend'] ?></td>
