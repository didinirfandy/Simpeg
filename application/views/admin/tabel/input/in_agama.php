    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                echo form_open('admin/input_tabel/agama',$attributes);?> 

                    <h3 class="tile-title">Form Input Tabel Agama</h3>
                    <p><?php echo $status_insert ?></p>
                    <div class="tile-body">
                        <form>
                            <div class="form-group">
                                <label class="control-label">Kode Agama</label>
                                <input class="form-control" type="text" name="kd_agama" placeholder="Masukan Kode Agama">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Nama Agama</label>
                                <input class="form-control" type="text" name="nm_agama" placeholder="Masukan Nama Agama">
                            </div>
                            <div class="form-group">
                        ...
                        <a class="btn btn-secondary" href="<?php echo base_url() ?>index.php/admin/kembali_tabel/out_agama"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                        </div>
                    </div>
                    <?php echo form_close() ?>
                </div>
