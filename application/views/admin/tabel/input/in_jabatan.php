...
<html lang="en">
    ...
    <main class="app-content">
        <div class="app-title">
        <div>
            <h1><i class="fa fa-th-list"></i> JABATAN </h1>
            <p></p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item">Tabel</li>
            <li class="breadcrumb-item active"><a href="<?php echo base_url() ?>index.php/admin/tabel/jabatan"> JABATAN </a></li>
        </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                echo form_open('admin/input_tabel/jabatan',$attributes);?> 

                    <h3 class="tile-title">Form Input Tabel Jabatan</h3>
                    ...
                    <div class="tile-body">
                        ...
                        <a class="btn btn-secondary" href="<?php echo base_url() ?>index.php/admin/kembali_tabel/out_jabatan"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                        </div>
                    </div>
                    <?php echo form_close() ?>
                </div>
